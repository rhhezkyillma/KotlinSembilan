...
class OtherAskType : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_other_ask_type)

        image = findViewById(R.id.image)
        post = findViewById(R.id.post_otherask)
        ...
        when (requestCode) {
            PERMISSION_REQUEST_CODE -> {
                if (grantResults.isEmpty() || grantResults[0]
                    == PackageManager.PERMISSION_GRANTED)
                    Toast.makeText(this@OtherAskType,
    ...
    private fun uploadFile() {
        ...
        var ref : StorageReference = storageReference.child("OtherAskType/"
